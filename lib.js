...
// Convertir la grilla en un objeto jardín
...
function crearNav(tipo) {
  ...
  //solo un botón activo globalmente
...
// asociar evento a la grilla para aplicar imagen seleccionada
